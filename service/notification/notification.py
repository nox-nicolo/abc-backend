...
def _push_copy(
    *,
    ...
    copy = {
        ...
        "booking_rejected": ("Booking declined", "The salon could not accept this booking. Choose another time when you are ready."),
        "booking_expired": ("Booking request expired", "This booking request expired because it was not approved before the appointment time."),
        "booking_cancelled": ("Booking cancelled", f"{actor_name} cancelled the booking"),
        "booking_completed": ("Service complete", "The salon marked your service complete. You can leave an optional review."),
        "booking_no_show": ("Marked no-show", "This booking was marked as no-show. Contact the salon if this looks wrong."),
